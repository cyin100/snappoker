...
export default function Home(){
  ...
  return (<div className="max-w-3xl mx-auto p-6 space-y-8">
    <header className="flex items-center justify-between"><h1 className="text-3xl font-bold">Snap Poker</h1><a href="#rules" className="text-slate-300 hover:underline">Rules</a></header>
